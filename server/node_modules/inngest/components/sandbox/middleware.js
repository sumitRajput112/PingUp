...
import { createSandboxTools, executeSandboxOperation } from "./durable.js";
...
const executeAsStep = async (client, operation) => {
	try {
		...
		if (error instanceof SandboxValidationError) throw new NonRetriableError(error.message, { cause: {
...
* replay.
*/
var SandboxMiddleware = class extends Middleware.BaseMiddleware {
	id = "inngest:sandbox";
